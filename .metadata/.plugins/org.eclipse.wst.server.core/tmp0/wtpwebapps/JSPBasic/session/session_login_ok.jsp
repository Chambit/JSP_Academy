...
<%
	...
	*/
	...
	String pw_c = request.getParameter("pw");
	String nick = request.getParameter("nick");
	
%>

	<% if(id_c.equals("aaa123") && pw_c.equals("1234")){ %>
		<% 	session.setAttribute("aaa123", id_c);	
			session.setAttribute("1234", pw_c);
			session.setAttribute("nick", nick);
		    response.sendRedirect("session_welcome.jsp");%>
	<%} else if(!id_c.equals("aaa123") || pw_c.equals("1234")){ %>
